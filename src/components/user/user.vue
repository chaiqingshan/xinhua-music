    ...
    <transition name="user">
        <div class="user">
            ...
            <mt-navbar v-model="selected" class="mtnav">
                <mt-tab-item id="1" class="mt-item"><span v-bind:class="{active:selected==='1'}">我的收藏</span>
                </mt-tab-item>
                <mt-tab-item id="2" class="mt-item"><span v-bind:class="{active:selected==='2'}">最近在听</span>
                </mt-tab-item>
            </mt-navbar>
            <div id="play">
                <!--先不显示这个图标-->
